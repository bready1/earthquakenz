...
X_test_filenames=filenames_shuffled
...
testing_batch_generator=blok_Generator(X_test_filenames,y_test,batch_size)
...
# model.load_weights('model_save12_newdata1_checkpoint')
# model.summary()

results=model.evaluate_generator(testing_batch_generator,steps=int(len(y_test)//batch_size),
verbose=True,
